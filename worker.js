...
const http_response_headers_set = {
    ...
    'X-Frame-Options': 'ALLOW FROM https://demo.betby.com', // IE
    'Content-Security-Policy': "frame-ancestors 'self' https://demo.betby.com;", // Chrome, Firefox, etc.
...
const replacement_rules = {
    ...
    'recaptcha' : 'betby_static',
    'google.com' : 'jacks.best',
    'demoapi.betby.com' : 's1.jacks.best',
}
...
const replacement_content_types = ['text/html', 'application/javascript'];
...
// ----------------------------------------------------------------------------------
// MAIN CODE
// You can make exceptions for paths (to send/receive balance & game responses)
// ----------------------------------------------------------------------------------
...
async function fetchAndApply(request) {
    ...
    if (blocked_regions.includes(region) || blocked_ip_addresses.includes(ip_address)) {
        ...
        new_request_headers.set('sid', 'wdvdc5p9m_1671189749441');
